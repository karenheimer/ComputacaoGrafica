...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">atividade06 documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="classes-links"' : 'id="xs-classes-links"' }>
                            <li class="link">
                                <a href="classes/Esfera.html" data-type="entity-link" >Esfera</a>
                            </li>
                            <li class="link">
                                <a href="classes/HitRecord.html" data-type="entity-link" >HitRecord</a>
                            </li>
                            <li class="link">
                                <a href="classes/Hittable.html" data-type="entity-link" >Hittable</a>
                            </li>
                            <li class="link">
                                <a href="classes/HittableList.html" data-type="entity-link" >HittableList</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="classes/Metal.html" data-type="entity-link" >Metal</a>
                            </li>
                            <li class="link">
                                <a href="classes/Vidro.html" data-type="entity-link" >Vidro</a>
                            </li>
                        </ul>
                    </li>
                    <li class="divider"></li>
